...
* **Деревянная воронка (*Wooden Hopper*) и Непрерывная заправка (`IFueledMachine`)**:
  ...
  * **Автоматическая дозаправка (Окно в 5 тиков)**: воронка сзади непрерывно подгружает топливо в топливный слот. За 5 тиков до окончания горения печь/плавильня/духовка/смешиватель автоматически сжигает следующее топливо из слота без затухания огня — ручной розжиг больше не требуется, пока в воронке есть топливо!
