...
* **Кирпичная печь (*Brick Furnace*)**: заменяет ванильную печь и плавильню.
  * **Только руды и блоки**: еда в кирпичную печь не помещается. Выплавляет из сырых кусков руды **самородки**.
...
* **Продвинутая плавильня (*Advanced Smelter*)**:
  ...
  * **Выплавка целых слитков**: усиленная железными пластинами конструкция обеспечивает сверхвысокую температуру и выплавляет из сырых руд и кусков (железо, медь, золото, олово, цинк) **полноценные целые слитки** вместо самородков!
