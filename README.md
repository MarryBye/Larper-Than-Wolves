...
* **Богатые почвы (*Rich Soils*)**:
  ...
  * **Просеивание в сите (Независимые шансы, чистые металлы)**: кремний, осколки и сплавы полностью исключены. Каждый металл рассчитывается независимо:
    1. **Медная пыль** — **40%** (Обычно)
    2. **Оловянная пыль** — **40%** (Наравне с медью)
    3. **Железная пыль** — **20%** (Редко)
