...
* **Заострённый камешек (*Pointed Pebble*)**:
  ...
  * **Выковыривание рудной пыли**:
    * Удар заострённым камешком по **Медной руде** (`copper_ore` / `deepslate_copper_ore`) выбивает **1 Медную пыль (*Copper Dust*)**, а истощённый рудный блок **замещается крепким булыжником**, который уже нельзя сколоть без настоящей кирки.
