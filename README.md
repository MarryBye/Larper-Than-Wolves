...
* **Стол-Просеиватель (*Sieve Table*)**:
  ...
  * **Повышенные шансы просеивания обычных грунтов**:
    * **Осколки кремня** — **40%** (было 30%)
    * **Кремень** — **22%** (было 15%)
    * **Медная пыль** — **8%** (было 5%)
* **Богатые почвы (*Rich Soils*)**:
  ...
  * **Просеивание в сите (Строго природные металлы)**: искусственные сплавы (бронзовая пыль) и камни (кремень/осколки) исключены. Выпадают только чистые металлические пыли: **Медная** (85%), **Оловянная** (55%), **Железная** (25%), **Золотая** (8%) и **Алмазная** (3%).
