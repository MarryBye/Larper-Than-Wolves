...
* **Стол-Просеиватель (*Sieve Table*)**:
  ...
  * **Сбалансированные шансы просеивания обычных грунтов**:
...
* **Богатые почвы (*Rich Soils*)**:
  ...
  * **Просеивание в сите (Независимые шансы, чистые металлы)**: кремний, осколки и сплавы полностью исключены. Каждый металл рассчитывается независимо, обеспечивая богатую добычу:
    1. **Медная пыль** — **85%** (Очень часто)
    2. **Оловянная пыль** — **55%** (Часто)
    3. **Железная пыль** — **25%** (Редко)
    4. **Золотая пыль** — **8%** (Очень редко)
    5. **Алмазная пыль** — **3%** (Супер редко)
