...
public class ModCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, "betterthangamers");

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BETTERTHANGAMERS_TAB =
            CREATIVE_MODE_TABS.register("betterthangamers_tab", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.betterthangamers"))
