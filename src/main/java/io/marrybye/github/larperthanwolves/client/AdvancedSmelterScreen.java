...
public class AdvancedSmelterScreen extends AbstractContainerScreen<AdvancedSmelterMenu> {
    ...
    public AdvancedSmelterScreen(AdvancedSmelterMenu menu, Inventory playerInventory, Component title) {
