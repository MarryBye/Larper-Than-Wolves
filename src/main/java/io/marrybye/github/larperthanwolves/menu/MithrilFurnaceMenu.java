...
public class MithrilFurnaceMenu extends AbstractContainerMenu {
    private final Container container;
    private final ContainerData data;
    private final ContainerLevelAccess levelAccess;

    // Client constructor
    public MithrilFurnaceMenu(int containerId, Inventory playerInventory, RegistryFriendlyByteBuf extraData) {
        this(containerId, playerInventory, new SimpleContainer(6), new SimpleContainerData(4), ContainerLevelAccess.NULL);
    }

    // Server constructor
    public MithrilFurnaceMenu(int containerId, Inventory playerInventory, Container container, ContainerData data, ContainerLevelAccess levelAccess) {
        super(ModMenuTypes.MITHRIL_FURNACE.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.levelAccess, player, ModBlocks.MITHRIL_FURNACE.get());
    }
