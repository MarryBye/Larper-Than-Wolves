...
public class DisabledItemsHandler {
    ...
    static {
        ...
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_SWORD, ModItems.REINFORCED_IRON_SWORD);
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_PICKAXE, ModItems.REINFORCED_IRON_PICKAXE);
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_AXE, ModItems.REINFORCED_IRON_AXE);
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_SHOVEL, ModItems.REINFORCED_IRON_SHOVEL);
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_HOE, ModItems.REINFORCED_IRON_HOE);

        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_HELMET, ModItems.REINFORCED_IRON_HELMET);
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_CHESTPLATE, ModItems.REINFORCED_IRON_CHESTPLATE);
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_LEGGINGS, ModItems.REINFORCED_IRON_LEGGINGS);
        REPLACEMENT_SUPPLIERS.put(Items.DIAMOND_BOOTS, ModItems.REINFORCED_IRON_BOOTS);
