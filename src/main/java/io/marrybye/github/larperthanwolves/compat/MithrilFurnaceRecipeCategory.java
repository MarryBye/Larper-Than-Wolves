...
public class MithrilFurnaceRecipeCategory implements IRecipeCategory<MithrilFurnaceJeiRecipe> {
    public static final RecipeType<MithrilFurnaceJeiRecipe> TYPE = RecipeType.create(LarperThanWolves.MODID, "mithril_furnace_smelting", MithrilFurnaceJeiRecipe.class);
    ...
    public MithrilFurnaceRecipeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(TEXTURE, 48, 14, 94, 58);
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(ModBlocks.MITHRIL_FURNACE.get()));
    ...
    @Override
    public RecipeType<MithrilFurnaceJeiRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.larperthanwolves.category.mithril_furnace");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, MithrilFurnaceJeiRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addInvisibleIngredients(RecipeIngredientRole.CATALYST)
                .addItemStack(new ItemStack(ModBlocks.MITHRIL_FURNACE.get()));
    }

    @Override
    public void draw(MithrilFurnaceJeiRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
