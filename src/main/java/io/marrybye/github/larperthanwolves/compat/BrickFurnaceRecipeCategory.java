...
public class BrickFurnaceRecipeCategory implements IRecipeCategory<BrickFurnaceJeiRecipe> {
    public static final RecipeType<BrickFurnaceJeiRecipe> TYPE = RecipeType.create(LarperThanWolves.MODID, "brick_furnace_smelting", BrickFurnaceJeiRecipe.class);
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(LarperThanWolves.MODID, "textures/gui/container/brick_furnace.png");
    ...
    public BrickFurnaceRecipeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(TEXTURE, 48, 14, 94, 58);
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(ModBlocks.BRICK_FURNACE.get()));
    ...
    @Override
    public RecipeType<BrickFurnaceJeiRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.larperthanwolves.category.brick_furnace");
    }
    ...
    @Override
    public void draw(BrickFurnaceJeiRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
